      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto text-left space-y-6">
          ...
          <div className="flex items-start space-x-4 bg-white p-4 rounded-lg shadow-lg text-gray-800">
            <img src={heroImage} alt="Wallet Icon" className="h-12 w-12" />
            <div>
              <h3 className="text-2xl font-bold mb-2">Step 1: Set Up a Crypto Wallet</h3>
              <p>
                If you don’t already have a crypto wallet, choose one that supports the Solana blockchain (e.g., Phantom or a Telegram bot like BonkBot). Download and install your chosen wallet.
              </p>
            </div>
          </div>
          <div className="flex items-start space-x-4 bg-white p-4 rounded-lg shadow-lg text-gray-800">
            <img src={heroImage2} alt="Funds Icon" className="h-12 w-12" />
            <div>
              <h3 className="text-2xl font-bold mb-2">Step 2: Add Funds to Your Wallet</h3>
              <p>
                Purchase Solana ($SOL) through your wallet or transfer it from another wallet or exchange. This crypto will be used to buy Dog on Bike Coin.
              </p>
            </div>
          </div>
          <div className="flex items-start space-x-4 bg-white p-4 rounded-lg shadow-lg text-gray-800">
            <img src={heroImage3} alt="Exchange Icon" className="h-12 w-12" />
            <div>
              <h3 className="text-2xl font-bold mb-2">Step 3: Connect to a Decentralized Exchange (DEX)</h3>
              <p>
                Visit a DEX like Pump.fun or Raydium where Dog on Bike Coin is available. Connect your wallet to the DEX using the wallet’s connect feature.
              </p>
            </div>
          </div>
          <div className="flex items-start space-x-4 bg-white p-4 rounded-lg shadow-lg text-gray-800">
            <img src={heroImage4} alt="Trade Icon" className="h-12 w-12" />
            <div>
              <h3 className="text-2xl font-bold mb-2">Step 4: Trade Solana ($SOL) for Dog on Bike Coin</h3>
              <p>
                Once connected, you can trade your Solana ($SOL) for Dog on Bike Coin. Follow the exchange's instructions to complete the transaction.
              </p>
            </div>
          </div>
        </div>
